                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>RollNo</label>
                                <input name="roll_no" type="text" class="form-control"  placeholder="Enter roll no">
                            </div>
                            <div class="form-group">
                                <label>Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="dept_name" type="text" class="form-control"  placeholder="Enter Department">
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Roll No</label>
                                <input value="{{ $student->roll_no }}" name="roll_no" type="text" class="form-control"  placeholder="Enter roll number">
                            </div>
                            <div class="form-group">
                                <label>Name</label>
                                <input value="{{ $student->name }}" name="name" type="text" class="form-control"  placeholder="Enter name">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                            ...
                            <div class="form-group">
                                <label>Department</label>
                                <input value="{{ $student->dept_name }}" name="dept_name" type="text" class="form-control"  placeholder="Enter Department">
                            </div>
